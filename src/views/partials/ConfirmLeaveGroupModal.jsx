...
const ConfirmLeaveGroupModal = ({
  ...
  return (
    <div
      ...
      className={`${styles.confirmLeaveBackground} closeLeaveGroupModal`}
    >
      <div className={styles.confirmLeaveModal}>
        ...
        <div className={styles.leaveBtnsCont}>
          <button
            onClick={(e) =>
              handleNevermindBtn(e, setIsOptsOpen, setIsConfirmLeaveOpen)
            }
            className={styles.noLeaveBtn}
            type="button"
          >
            Nevermind
          </button>
